	...
	<div id="default-carousel" class="relative" data-carousel="static">
        ...
        <div class="overflow-hidden relative h-56  sm:h-64 xl:h-80 2xl:h-96">
            ...
            <div class="hidden duration-300 ease-in-out" data-carousel-item>
                <img src="add.jpg" class=" object-cover  block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
            </div>
           
            <div class="hidden duration-300 ease-in-out" data-carousel-item>
                <img src="ankit2.JPG" class="object-cover block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
            </div>
            <div class="hidden duration-300 ease-in-out" data-carousel-item>
                ...
                <img src="ankit.JPG" class="object-cover  block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
            </div>
